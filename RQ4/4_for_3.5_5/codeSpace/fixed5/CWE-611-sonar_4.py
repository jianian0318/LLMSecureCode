...
def get_root():
    '''
    Create an XML parser, parse the file 'resources/config.xml' and return the root element of the XML.
    '''

    # Create an instance of the custom XML handler
    handler = CustomContentHandler()

    # Create a parser object using defusedxml to avoid XML vulnerabilities
    parser = make_parser()
