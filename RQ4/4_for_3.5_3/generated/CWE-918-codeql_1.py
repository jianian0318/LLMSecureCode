...
def full_ssrf():
    ...
    # Construct the URL using the valid subdomain, preventing SSRF by validating the subdomain
...
if __name__ == "__main__":
    app.run(debug=False)  # Debug mode is turned off for production or public use to avoid CWE-94 and CWE-215 issues