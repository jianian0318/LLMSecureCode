...
def profile():
    # Get raw_data from request with utf-8 encoding and decode it from base64.
    raw_data = request.get_data(as_text=True)
    decoded_data = base64.b64decode(raw_data).decode('utf-8')  # Decode b64 data and ensure it is a UTF-8 string
    ...
    escaped_profile_data = {key: escape(str(value)) for key, value in profile_data.items()}
